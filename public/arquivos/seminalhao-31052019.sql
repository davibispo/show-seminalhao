...
--
-- Host: 127.0.0.1
-- Generation Time: 31-Maio-2019 às 17:00
...
(7, 'Qual o local de nascimento do profeta Joseph Smith?', '1', '3', '0', '1', '2019-04-05 14:18:44', '2019-04-05 14:18:44'),
...
(26, 'Em qual local aconteceu a organização da Igreja de Jesus Cristo dos Santos dos Últimos Dias?', '1', '3', '1', '1', '2019-04-08 04:32:25', '2019-04-08 04:32:25'),
(27, 'Quem foi a primeira presidente da Sociedade de Socorro da Igreja?', '1', '1', '0', '1', '2019-04-08 04:45:48', '2019-04-08 04:45:48'),
...
(61, 'De acordo com Joseph Smith - História, qual foi o dia do casamento de Joseph com Emma Hale?', '1', '2', '0', '1', '2019-04-16 14:34:23', '2019-05-14 18:04:44'),
...
(66, 'O que é Revelação Pessoal?', '1', '2', '0', '1', '2019-04-16 16:46:28', '2019-04-16 16:51:30'),
...
(69, 'Na escritura de domínio doutrinário D&C 6:36 está escrito:', '1', '2', '0', '1', '2019-04-16 18:33:21', '2019-05-13 17:59:16'),
...
(83, 'Complete a escritura corretamente (D&C 82:10): Eu, o Senhor, estou obrigado quando fazeis o que eu digo; __________________________________________.', '1', '1', '0', '1', '2019-05-10 18:04:31', '2019-05-10 18:05:14'),
(84, 'Em qual escritura de D&C encontramos que \"o valor das almas é grande à vista de Deus\"?', '1', '2', '0', '1', '2019-05-14 18:10:50', '2019-05-14 18:10:50'),
(85, 'A doutrina da alegria de trazer almas a Jesus Cristo é encontrada onde?', '1', '2', '0', '1', '2019-05-14 18:19:50', '2019-05-14 18:19:50');
...
(83, 'e quando não o fazeis, não tendes promessa alguma.', 'mas quando não o fazeis, não tendes promessa alguma.', 'mas quando não o fazeis, tendes promessa alguma.', 'e quando o fazeis, não tendes promessa alguma.', '2', 83, '2019-05-10 18:08:55', '2019-05-10 18:08:55'),
(84, 'D&C 18:15', 'D&C 19:11', 'D&C 19:16', 'D&C 18:10', '4', 84, '2019-05-14 18:18:12', '2019-05-14 18:18:12'),
(85, 'D&C 18:15-16', 'D&C 18:10-11', 'D&C 19:16-19', 'D&C 29:10-11', '1', 85, '2019-05-14 18:22:04', '2019-05-14 18:22:04');
...
CREATE TABLE `users` (
  ...
  `pulos` char(1) COLLATE utf8mb4_unicode_ci DEFAULT '1',
  `ajudas` char(1) COLLATE utf8mb4_unicode_ci DEFAULT '1',
...
INSERT INTO `users` (`id`, `name`, `ala`, `pergunta_tipo`, `pontuacao`, `pulos`, `ajudas`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(4, 'adfadsf', 'adsfad', '1', 0, '1', '1', '$2y$10$P/WL4JWAdcaceJC1gOHkv.QjVGpCkiZZYQare6qOu8drdhcLTXnly', '98pIKVsE4fYVVzUd7DLJUkHNE5c2fmBzFC4cZgO7JTBMwZAY87DLSTvtDxl6', '2019-05-14 17:13:38', '2019-05-14 17:13:38'),
(5, 'Davi', 'Pratagy', '1', 0, '0', '1', '$2y$10$p91ZowGNRBP/59vEcwgF1ucQAw47OE9jBvmF6X7dIcMCMaDwLCdD2', 'wnDlmv53GBvPVPnKPhvYWgHhIBuvhicvt4CadEfIgDRGSFTXKi7kxtDkghLR', '2019-05-14 17:16:41', '2019-05-14 17:16:41'),
(6, 'José Mario', 'Benedito Bentes', '1', 15, '1', '0', '$2y$10$S4FpGX1CC7aHUK0EyVjH0OyI.pXuHGN2STk6tBuiVmVu5yg/VCcBG', 'PjfwJpn7IKm2PADncqOwcB6cOAVW10ir0aDI8PIqcuEFUlUqzTCWXdjM8OgS', '2019-05-14 17:34:27', '2019-05-14 17:34:27'),
(7, 'Davi Bispo', 'PRA', '1', 0, '1', '1', '$2y$10$G7dZVbw0tXbEB52bfj.gI.nTvnpeI83k6/w4MZsBd98DQNH0R5FYC', 'ATbEMFBMgTYreZoOweEySMUjXuGxtELFP2buthPiFtOw7BFnuwVbfAR0w7Ip', '2019-05-14 17:44:47', '2019-05-14 17:44:47'),
(8, 'Carlos', 'GUR', '1', 40, '1', '1', '$2y$10$MCZwaHQ4X1Jle4HlC7ry9e/xwXBakeLY/.0NznIgHz3kP1mqml8I.', 'aDD5PULJlqqhdnTgVMGCcPdYqbQq86BnYpr05mOnul6VlHqrTF9qfUtH8rYZ', '2019-05-14 18:02:28', '2019-05-14 18:02:28'),
(9, 'Davi Bispo', 'Pratagy', '1', 40, '1', '1', '$2y$10$/yvqEAyUf07uLe67r6LbbuH3wIDhdnibpFjDWsqq8HMvUUFBRO2IO', NULL, '2019-05-22 17:53:45', '2019-05-22 17:53:45');
